...
const RFQCard = ({ rfq }) => {
  ...
  return (
    <div className="w-full h-full border rounded-lg border-gray-300">
      <h3 className="px-4 py-2 border-b font-semibold text-xl border-gray-300">
        RFQ Overview
      </h3>
      <div className="flex gap-2 md:gap-1">
        <div className="flex flex-col gap-2 border-r-2 border-gray-300 my-6 mx-2">
          <div className="flex gap-36 px-8">
            <h4 className="text-sm font-normal text-gray-500">RFQ ID:</h4>
            <span className="text-sm font-normal text-black">#{rfq.RFQ_ID}</span>
          </div>
          <div className="flex gap-36 px-8">
            <h4 className="text-sm font-normal text-gray-500">Name:</h4>
            <span className="text-sm font-normal text-black">{rfq.RFQ_Name}</span>
          </div>
          <div className="flex gap-36 px-8">
            <h4 className="text-sm font-normal text-gray-500">Fecha:</h4>
            <span className="text-sm font-normal text-black">{rfq.RFQ_Date}</span>
          </div>
          <div className="flex gap-32 px-8">
            <h4 className="text-sm font-normal text-gray-500">Company:</h4>
            <span className="text-sm font-normal text-black">{rfq.Company_Name}</span>
          </div>
        </div>
        <div className="flex-1 gap-2 ">
          <div className="flex flex-col gap-2 my-6 mx-2">
            ...
            <div className="flex gap-36 px-8">
              <h4 className="text-sm font-normal text-gray-500 whitespace-wrap">URL:</h4>
